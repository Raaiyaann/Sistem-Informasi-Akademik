...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <li class="text-gray-900 font-medium">Edit Dosen</li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Edit Data Dosen</h2>
                <p class="text-gray-600">Perbarui informasi dosen: <span class="font-medium text-gray-900">{{ $dosen->nama }}</span></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
        <div class="flex items-start gap-4">
            <div class="w-10 h-10 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-lg flex items-center justify-center flex-shrink-0">
                <span class="text-white font-bold text-lg">{{ substr($dosen->nama, 0, 1) }}</span>
            </div>
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $dosen->nama }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">NIP</p>
                        <p class="font-medium text-gray-900">{{ $dosen->nip }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Bidang Keahlian</p>
                        <p class="font-medium text-gray-900">{{ $dosen->bidang_keahlian }}</p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Username</p>
                        <p class="font-medium text-gray-900">{{ $dosen->user->username ?? 'Belum ada akun' }}</p>
                    </div>
                </div>
                <div class="mt-4 flex items-center gap-4 text-sm text-gray-600">
                    <span class="flex items-center gap-1">
                        ...
                        Dibuat: {{ $dosen->created_at->format('d M Y') }}
                    </span>
                    <span class="flex items-center gap-1">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>
                        </svg>
                        Diupdate: {{ $dosen->updated_at->format('d M Y') }}
                    </span>
                </div>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('nip') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 @error('bidang_keahlian') border-red-500 @enderror"
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-yellow-800 space-y-1">
                            <li>• Perubahan data akan mempengaruhi akses login dosen</li>
                            <li>• Jika mengubah username, dosen harus login dengan username baru</li>
                            <li>• Password hanya diubah jika field diisi, kosongkan jika tidak ingin mengubah</li>
...
// Fungsi resetForm tidak diperlukan lagi karena tombol reset dihapus

function confirmDelete() {
    return confirm('PERINGATAN: Menghapus dosen akan menghapus semua data terkait termasuk bimbingan mahasiswa dan mata kuliah. Tindakan ini tidak dapat dibatalkan!\n\nKetik "HAPUS" untuk konfirmasi:') && 
...
document.querySelector('form').addEventListener('submit', function(e) {
    const requiredFields = ['nama', 'nip', 'email', 'bidang_keahlian', 'username'];
    let hasError = false;
...
// Hilangkan popup leave site saat edit data
